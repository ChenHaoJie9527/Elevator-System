...
- **PassengerElevator**: minFloor `1` → `-2`
- **FreightElevator**: minFloor `-1` → `-2`
- **ScenicElevator**: minFloor `1` → `-2`
- **VIPElevator**: minFloor `1` → `-2`
- **SmartElevator**: minFloor `1` → `-2`
